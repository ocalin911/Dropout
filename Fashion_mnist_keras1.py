...
#Dropout optimization for Fashion Mnist data set
#The setup is for plotting the accuracy versus the dropout rate
#Use the commened out rows to obtain the plot of loss versus dropout rate
...
plt.title('Accuracy versus dropout rate for fashion mnist data')
#plt.title('Loss versus dropout rate for fashion mnist data')
plt.show()    
#model.summary()
